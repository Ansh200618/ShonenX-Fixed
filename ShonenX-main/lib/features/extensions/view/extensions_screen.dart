    ...
    return [
      ...
      IconButton(
        onPressed: () async {
          ...
          if (manager.supportsAnime) await manager.fetchAvailableAnimeExtensions(null);
          if (manager.supportsManga) await manager.fetchAvailableMangaExtensions(null);
          if (manager.supportsNovel) await manager.fetchAvailableNovelExtensions(null);
        },
